...
//That is why Uf follows after this loop
{
	 ...
	 #include "swellingPressureModel.H" //Swelling pressure model	
         ...
         fluid.correct(); //Non-Newtoninan Viscocity Update
...
/////////////////////FLUID VELOCITY SECTION//////////////////////////////////////////
	    ...
	    //can you add an iterative term here to account for 
	    //the fact that we use div(U)=0 in the incompressible solver?
